...
DTK_House_Shop_1 addaction ["","noscript.sqf","[]call house_market;", 25, false, true, "LeanRight",format ["player distance _target < 5 && {!([_target,'House Market (E)','data\images\misc\bank']call tag_show)}","",""]];
DTK_House_Shop_2 addaction ["","noscript.sqf","[]call house_market;", 25, false, true, "LeanRight",format ["player distance _target < 5 && {!([_target,'House Market (E)','data\images\misc\bank']call tag_show)}","",""]];
DTK_House_Shop_3 addaction ["","noscript.sqf","[]call house_market;", 25, false, true, "LeanRight",format ["player distance _target < 5 && {!([_target,'House Market (E)','data\images\misc\bank']call tag_show)}","",""]];
