...
DTK_Shop_Oil_1 addaction ["","scripts\itemprocess.sqf",["Oil", "OilBarrel", 2,"DTK_License_civ_oil"], 25, false, true, "LeanRight",format ["player distance _target < 5 && {!([_target,'Process Oil (E)','data\images\tags\oil']call tag_show)}","",""]];
