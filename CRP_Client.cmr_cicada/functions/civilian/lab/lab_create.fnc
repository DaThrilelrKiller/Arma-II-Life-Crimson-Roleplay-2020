...
_lab addaction ["","noscript.sqf",format["%1 call lab_open",_lab], 25, false, true, "LeanRight",format ["player distance _target < 5 && {!([_target,'Open Lab (E)','\crp_data\images\tags\meth']call tag_show)}","",""]];
...
["ALL",[_lab,['','noscript.sqf',format['deleteVehicle %1;',_lab],25,false,true,'LeanRight',format ['dtk_cop && {player distance _target < 5} && {!([_target,"Remove Drug Lab (E)","%1"]call tag_show)}',"\crp_data\images\tags\meth"]]],"network_addAction",false,true]call network_MPExec;