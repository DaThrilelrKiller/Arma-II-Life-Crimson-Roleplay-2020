...
rathaus addaction ["","noscript.sqf",'call goverment_vote;',25,false,true,"LeanRight","player distance _target < 5 && {!([_target,'Vote(E)','\crp_data\images\misc\bank']call tag_show)}"];
