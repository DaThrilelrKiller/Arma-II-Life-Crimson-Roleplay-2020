...
if (_option == "dtk_repair")then {
	...
	for "_i" from 1 to 100 step 1 do {
			[format['Repairing you rusy POS... %1%2',_i,"%"],'data\images\items\exhaust',true]call tag_notify;
			uiSleep 0.1;
...
if (_option == "dtk_refual")then {
	for "_i" from 1 to 100 step 1 do {
			[format['Refueling Vehicle... %1%2',_i,"%"],'data\images\items\exhaust',true]call tag_notify;
			uiSleep 0.1;
			if(!alive player)exitWith {};
			if (_i == 100)exitWith {
				_vehicle setFuel 1;
