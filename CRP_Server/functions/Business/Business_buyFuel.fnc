...
private _curOwnerUid = ["Businesses", _section, "OwnerUID", ""] call s_stats_read;
private _curOwnerName = ["Businesses", _section, "OwnerName", ""] call s_stats_read;
private _balance = ["Businesses", _section, "Balance", 0] call s_stats_read;
private _forSale = ["Businesses", _section, "ForSalePrice", 0] call s_stats_read;

private _buyerUid = getPlayerUID _buyer;
private _buyerName = name _buyer;
...
if (_curOwnerUid == "") then {
	...
	private _expected = if (isNil "dtk_fuelStationBuyPrice") then {250000} else {dtk_fuelStationBuyPrice};
...
private _sellerUid = _curOwnerUid;
private _sellerBank = [_sellerUid, "Main", "Bank", 45000] call s_stats_read;
private _payout = _forSale + _balance;
