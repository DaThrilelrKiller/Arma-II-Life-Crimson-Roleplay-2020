...
["ALL",[_object,['','noscript.sqf',format["[%1,%2]spawn spill_fix",_object,_markers],25,false,true,'LeanRight',format ['dtk_ems && {player distance _target < 8} && {!([_target,"Clean up chemical spill(E)","\crp_data\images\tags\spill"]call tag_show)}',_name13,_image]]],"network_addAction",false,true]call network_MPExec;
